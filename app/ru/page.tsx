...
const services = [
  ...
  {
    title: "Кабельные трассы для солнечных и ветровых проектов",
    text: "Прокладка подземных кабелей, защитных труб и проходов для электроподключений солнечных парков и объектов ветроэнергетики.",
  },
];
...
export const metadata: Metadata = {
  title: "Горизонтальное бурение и подземные кабельные трассы в Латвии",
  description:
    "RNNP выполняет горизонтально направленное бурение, прокол под дорогой, бестраншейную прокладку труб, кабелей, водопровода, канализации и кабельные трассы для солнечных и ветровых проектов в Латвии.",
  alternates: {
    canonical: "/ru",
    languages: {
      "lv-LV": "/",
  ...
  keywords: [
    ...
    "коммуникации для коммерческих объектов",
    "прокладка коммуникаций для объекта",
    ...
    "бурение под дорогой Рига",
    "бурение под дорогой цена",
    ...
    "кабельные линии для солнечных парков",
    "солнечный парк кабельные трассы",
    "кабель для солнечной электростанции",
    "прокладка кабеля для солнечной электростанции",
    ...
    "кабель для ветровой электростанции",
  ...
  openGraph: {
    ...
    url: "/ru",
    siteName: "RNNP",
    title: "RNNP | Горизонтальное бурение и подземные кабельные трассы",
    description:
      "Бестраншейная прокладка труб, кабельных линий, водопровода, канализации и кабельных трасс для солнечных и ветровых проектов в Латвии.",
  },
};
  ...
  const jsonLd = {
    ...
    "@graph": [
      ...
      },
      {
        ...
        areaServed: "Латвия",
        description:
          "RNNP выполняет горизонтальное бурение, прокол под дорогой, бестраншейную прокладку труб, кабельных линий, водопровода, канализации и кабельных трасс для солнечных и ветровых проектов в Латвии.",
      },
      {
        "@type": "FAQPage",
        "@id": `${siteUrl}/ru#faq`,
        ...
        <div className="mx-auto grid max-w-7xl gap-8 px-4 py-14 sm:px-6 sm:py-16 lg:grid-cols-[0.85fr_1.15fr] lg:px-10">
          ...
          <div>
            <p className="text-base leading-7 text-[#514f70] sm:text-lg sm:leading-8">
              ...
              связь, солнечные парки, объекты ветроэнергетики и защитные трубы
              в местах, где траншея была бы дорогой, долгой или повредила бы
              покрытие.
            </p>
          </div>
        </div>
